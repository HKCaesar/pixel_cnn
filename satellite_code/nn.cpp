...
//    serial_image_preprocessing(train_file[0],rw,temp_image);
    ...
    time_start = TimeValue_Start.tv_sec * 1000000 + TimeValue_Start.tv_usec;
    time_overhead = (time_end - time_start)/1000000.0;
    cout<<"\nTotal time for training by parallel algorithom ="<<time_overhead;
    ...
    time_start = TimeValue_Start.tv_sec * 1000000 + TimeValue_Start.tv_usec;
    time_overhead = (time_end - time_start)/1000000.0;
    cout<<"\nTotal time for training by serial algorithom="<<time_overhead;
    ...
    time_start = TimeValue_Start.tv_sec * 1000000 + TimeValue_Start.tv_usec;
    time_overhead = (time_end - time_start)/1000000.0;
    cout<<"\nTotal time for testing by optimal parallel algorithom="<<time_overhead;
    ...
    time_start = TimeValue_Start.tv_sec * 1000000 + TimeValue_Start.tv_usec;
    time_overhead = (time_end - time_start)/1000000.0;
    cout<<"\nTotal time for testing by parallel algorithom="<<time_overhead;
    gettimeofday(&TimeValue_Start, &TimeZone_Start);
   convolutional_neural_network_testing<convolutional_net_layer,serial_softmax_error>(cnn,future,NO_LAYERS,temp_image[0],RGB_IMAGE_X,RGB_IMAGE_Y,NO_CLASS,rw[0]->train_array);
    ...
    time_start = TimeValue_Start.tv_sec * 1000000 + TimeValue_Start.tv_usec;
    time_overhead = (time_end - time_start)/1000000.0;
    cout<<"\nTotal time for testing by serial algorithom="<<time_overhead;
